...
const SliderOnmodel = () => {
  ...
  const changeSlide = useCallback(
    (indexx, imagesss) => {
      ...
      var style_model_product = []
      if (on_me === 'on' && isMobile) {
        style_model_product = {
          transformOrigin: KoordinatsModels[key_koordinat].model.transformOrigin[indexx],
          transformOriginOnMe: KoordinatsModels[key_koordinat].model.transformOriginOnMe[indexx],
          widthBox: KoordinatsModels[key_koordinat].model.marginOnMe.widthBox[indexx],
          topBox: KoordinatsModels[key_koordinat].model.marginOnMe.topBox[indexx],
          right: KoordinatsModels[key_koordinat].model.marginOnMe.right[1],
          bottom: KoordinatsModels[key_koordinat].model.marginOnMe.bottom[1],
          ...
          marginLeftMobile: KoordinatsModels[key_koordinat].model.marginOnMe.marginLeft[indexx],
          marginTopMobile: KoordinatsModels[key_koordinat].model.marginOnMe.marginTop[indexx],
        ...
        style_model_product = {
          ...
          widthBox: KoordinatsModels[key_koordinat].model.marginOnMe.widthBox[indexx],
          topBox: KoordinatsModels[key_koordinat].model.marginOnMe.topBox[indexx],
          right: KoordinatsModels[key_koordinat].model.marginOnMe.right[0],
          bottom: KoordinatsModels[key_koordinat].model.marginOnMe.bottom[0],
          rotasi: KoordinatsModels[key_koordinat].model.rotasi[indexx],
          scale: KoordinatsModels[key_koordinat].model.scaleMobile[indexx],
          transformDesktop: KoordinatsModels[key_koordinat].model.transformDesktop[indexx],
          marginLeftMobile: KoordinatsModels[key_koordinat].model.marginOnMe.marginLeft[indexx],
      ...
      //     transformOrigin: KoordinatsModels[key_koordinat].model.transformOrigin[indexx],
      //     transformOriginOnMe: KoordinatsModels[key_koordinat].model.transformOriginOnMe[indexx],
      //     widthBox: KoordinatsModels[key_koordinat].model.marginMobiled.widthBox[indexx],
      //     topBox: KoordinatsModels[key_koordinat].model.marginMobiled.topBox[indexx],
      //     right: KoordinatsModels[key_koordinat].model.marginMobiled.right[indexx],
      //     bottom: KoordinatsModels[key_koordinat].model.marginMobiled.bottom[indexx],
      //     rotasi: KoordinatsModels[key_koordinat].model.rotasi[indexx],
      //     scale: KoordinatsModels[key_koordinat].model.scaleMobile[indexx],
      //     transformDesktop: KoordinatsModels[key_koordinat].model.transformDesktop[indexx],
      //     marginLeftMobile: KoordinatsModels[key_koordinat].model.marginMobiled.marginLeft[indexx],
      //     marginTopMobile: KoordinatsModels[key_koordinat].model.marginMobiled.marginTop[indexx],
      //     BGPositionMobile: [KoordinatsModels[key_koordinat].model.bgPositionX[indexx], KoordinatsModels[key_koordinat].model.bgPositionY[indexx]],
      //     BGSizeMobile: KoordinatsModels[key_koordinat].model.bgSizeMobile[indexx],
      //     marginLeftDesktop: KoordinatsModels[key_koordinat].model.marginDesktop.marginLeft[indexx],
      //     marginTopDesktop: KoordinatsModels[key_koordinat].model.marginDesktop.marginTop[indexx],
      ...
      // } 
        ...
        style_model_product = {
          transformOrigin: KoordinatsModels[key_koordinat].model.transformOrigin[indexx],
          transformOriginOnMe: KoordinatsModels[key_koordinat].model.transformOriginOnMe[indexx],
          widthBox: KoordinatsModels[key_koordinat].model.marginDesktop.widthBox[indexx],
          topBox: KoordinatsModels[key_koordinat].model.marginDesktop.topBox[indexx],
          right: KoordinatsModels[key_koordinat].model.marginDesktop.right[indexx],
          bottom: KoordinatsModels[key_koordinat].model.marginDesktop.bottom[indexx],
          rotasi: KoordinatsModels[key_koordinat].model.rotasi[indexx],
          scale: KoordinatsModels[key_koordinat].model.scaleMobile[indexx],
          transformDesktop: KoordinatsModels[key_koordinat].model.transformDesktop[indexx],
          marginLeftMobile: KoordinatsModels[key_koordinat].model.marginDesktop.marginLeft[indexx],
          marginTopMobile: KoordinatsModels[key_koordinat].model.marginDesktop.marginTop[indexx],
          BGPositionMobile: [KoordinatsModels[key_koordinat].model.bgPositionX[indexx], KoordinatsModels[key_koordinat].model.bgPositionY[indexx]],
          BGSizeMobile: KoordinatsModels[key_koordinat].model.bgSizeMobile[indexx],
          marginLeftDesktop: KoordinatsModels[key_koordinat].model.marginDesktop.marginLeft[indexx],
          marginTopDesktop: KoordinatsModels[key_koordinat].model.marginDesktop.marginTop[indexx],
      ...
      if (on_me === 'on') {
        document.getElementById('box-onmodel').style.transformOrigin = `${style_model_product.transformOriginOnMe}`
      } else {
